...
Add or update manual QA documentation for validating V2.2 creative application output against the product complaint. The QA notes should compare app-generated output with a direct-chat baseline using the same model and should cover both the Vejle Kommune AI-builder scenario and the Milestone 2 backend-platform real-provider QA scenario.

The slice should give a human tester a concrete checklist for judging whether the app now produces richer, more specific, and still auditable drafts.
